...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private void StoreTrades(IEnumerable<TradeRecord> trades)
        {
            ...
            string jonnyConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\jsaldin\Documents\tradedatabase.mdf;Integrated Security=True;Connect Timeout=30";
            // Change the connection string used to match the one you want
            using (var connection = new SqlConnection(jonnyConnectionString))
            {
